...
if not options.useData :
	...
	if not options.useSusyFilter :
		process.source.fileNames = [
                    #'file:data_eos/SevenTev/sample/slt_fastsim.root'
                    ...
                    # Rutgers WbG 150 TopBSM test
                    #'/store/user/kukarzev/Rutgers_WbG_150GeV_v1_Fastsim-AODSIM/Rutgers_WbG_150GeV_v1_Fastsim-AODSIM/a8bf618d403128b39aae1dcec092178c/output_1_1_R6K.root'

                    # MG5 150 no cuts
                    '/store/user/kukarzev/t1t1bar_WbG_150GeV_nocuts_MG5_v1_Fastsim-AODSIM/t1t1bar_WbG_150GeV_nocuts_MG5_v1_Fastsim-AODSIM/a8bf618d403128b39aae1dcec092178c/output_11_1_2GK.root'
...
#muons
process.isoValMuonWithNeutralPFlow.deposits[0].deltaR = 0.4
process.isoValMuonWithChargedPFlow.deposits[0].deltaR = 0.4
process.isoValMuonWithPhotonsPFlow.deposits[0].deltaR = 0.4
#electrons
process.isoValElectronWithNeutralPFlow.deposits[0].deltaR = 0.4
process.isoValElectronWithChargedPFlow.deposits[0].deltaR = 0.4
process.isoValElectronWithPhotonsPFlow.deposits[0].deltaR = 0.4
...
process.patMuonsLoosePFlow.usePV = cms.bool(False)
print "patMuons.usePV=", process.patMuons.usePV
print "patMuonsPFlow.usePV=", process.patMuonsPFlow.usePV
print "patMuonsLoosePFlow.usePV=", process.patMuonsLoosePFlow.usePV
...
if options.useData :
    ...
    if options.writeFat :
        ...
        #process.out.fileName = cms.untracked.string('data_eos/SevenTev/sync/top2011/ttbar_'+'ttbsm_' + fileTag + '_mc_v3.root')
        #process.out.fileName = cms.untracked.string('data_eos/Rutgers_WbG_150GeV_v1_Fastsim-AODSIM/TopBSM_test1/wbg150_'+'ttbsm_' + fileTag + '_mc.root')
